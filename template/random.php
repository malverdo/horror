                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="breadcumb-wrap text-center">
                            <h2>Случайная история</h2>
                            <ul>
                                <li><a href="?path=/">Главная</a></li>
                                <li>/</li>
                                
                                <li class="active"><?php print_r($_SESSION['history'][$params['random1']][1]);?></li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-8 col-xs-12">
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="blog-wrap">
                                    <div class="blog-img">
                                        <img src="<?php print_r($_SESSION['history'][$params['random1']][4]);?>" alt="" >
                                    </div>
                                    <div class="blog-content">
                                        <ul class="blog-meta">
                                            <li><a href="#"><i class="fa fa-clock-o"></i><?php print_r($_SESSION['history'][$params['random1']][7]);?></a></li>
                                            <li><a href="#"><i class="fa fa-eye"></i> <?php print_r($_SESSION['history'][$params['random1']][8]);?></a></li>
                                            <li><a href="#"><i class="fa fa-hourglass-start"></i> <?php print_r($_SESSION['history'][$params['random1']][6]);?></a></li>
                                        </ul>
                                        <h3><?php print_r($_SESSION['history'][$params['random1']][1]);?></h3>
                                    </div>
                                </div>
                                <div class="blog-details-wrap" style="font-size: 16px;">
                                    <p><?php print_r($_SESSION['history'][$params['random1']][3]);?></p>
                    ...
                    <div class="col-md-4 col-xs-12 col-sm-6">
                        <aside class="sidebar-wrap">
                            ...
                            <div class="widget sidebar-menu">
                                <a href="?path=/updates"><h3 class="widget-title">Последние добавления</h3></a>
                                <ul>
									<?php for ($i=0; $i < 8; $i++):?>
